...
class HYMealModel {
  ...
  @override
  String toString() {
    return 'HYMealModel{id: $id, categories: $categories, title: $title, affordability: $affordability, complexity: $complexity, complexStr: $complexStr, imageUrl: $imageUrl, duration: $duration, ingredients: $ingredients, steps: $steps, isGlutenFree: $isGlutenFree, isVegan: $isVegan, isVegetarian: $isVegetarian, isLactoseFree: $isLactoseFree}';
  }
}
